...
def generate_tree_with_content(root_path: Path, output_file: Path):
    ...
    el contenido de los archivos de código (p. ej. .java, .tsx, .js, .ts), manteniendo un orden consistente.
    """
    tree_lines = []
    content_blocks = []
    ...
    for root_str, dirs, files in os.walk(root_path):
        ...
        for file_name in files:
            # incluir múltiples extensiones objetivo
...
if __name__ == "__main__":
    ...
    # Actualizar mensaje para las extensiones buscadas
    print(f"🔍 Buscando archivos: .java, .tsx, .js, .ts ...")
