          ...
          <div className="py-7">
            ...
            <div className="flex border-t-2 border-gray-300 py-5">
              ...
              <section className="flex flex-col gap-3">
                <h3 className="text-lg font-bold">Congelador de Racha</h3>
                <p className="text-sm text-gray-500">
                  El Congelador de Racha permite que tu racha se mantenga durante
            ...
            <div className="flex border-t-2 border-gray-300 py-5">
              ...
              <section className="flex flex-col gap-3">
                <h3 className="text-lg font-bold">Doble o Nada</h3>
                <p className="text-sm text-gray-500">
                  Intenta duplicar tu apuesta de cinco puntos QA manteniendo una
                  racha de siete días.
                </p>
                <button
                  className="flex w-fit items-center gap-1 rounded-2xl border-2 border-gray-300 bg-white px-4 py-2 text-sm font-bold uppercase text-gray-300"
                  disabled
                >
                  Obtener por: <EmptyGemSvg /> 5
                </button>
              </section>
            </div>
          </div>
          <div className="py-7">
            <h2 className="mb-5 text-2xl font-bold">Merchandising</h2>
            <div className="flex border-t-2 border-gray-300 py-5">
              <DuoPlushieSvg className="h-32 w-32 shrink-0 p-4" />
              <section className="flex flex-col gap-3">
                <h3 className="text-lg font-bold">Peluche QA</h3>
                <p className="text-sm text-gray-500">
                  ¡Celebra el décimo aniversario de QA Learning con un peluche exclusivo!
                </p>
