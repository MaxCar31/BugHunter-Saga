...
/**
 * Componente que muestra una etiqueta flotante con animación bounce
 * Se auto-centra dinámicamente según el ancho del texto
 */
export const HoverLabel: React.FC<HoverLabelProps> = ({
  ...
  return (
    <div
      className={`absolute z-10 w-max animate-bounce rounded-lg border-2 border-gray-200 bg-white px-3 py-2 font-bold uppercase shadow-lg ${textColor}`}
      style={{
        top: "-25%",
