export const FireSvg = () => {
  return (
    <svg width="25px" height="30px" viewBox="0 0 25 30">
      <defs>
        {/* Gradiente principal del fuego */}
        <linearGradient id="fireGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#FCD34D" />
          <stop offset="50%" stopColor="#F59E0B" />
          <stop offset="100%" stopColor="#DC2626" />
        </linearGradient>
        {/* Gradiente del centro (llama interior) */}
        <linearGradient id="fireInnerGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#FEF3C7" />
          <stop offset="100%" stopColor="#FBBF24" />
        </linearGradient>
        {/* Gradiente del borde */}
        <linearGradient id="fireBorderGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#FEF3C7" />
      ...
      >
        <g
          ...
          fillRule="nonzero"
        >
          {/* Llama exterior con gradiente mejorado */}
          <g id="Group" fill="url(#fireGradient)" stroke="url(#fireBorderGradient)" strokeWidth={1.5}>
            <path
